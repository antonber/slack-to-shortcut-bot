...
export async function fetchThread(
  ...
  // First, fetch the message that was reacted to — it might not be a thread parent
  ...
  // If the reacted message has a thread_ts different from its own ts,
...
function mapMessages(
  messages: NonNullable<
    Awaited<
      ReturnType<typeof slack.conversations.replies>
    >["messages"]
  >
): SlackMessage[] {
